...
The figure below shows ssh tunnels to *node1* and *node 2* opened by two users via the host *moledyn.ace-net.training*. In this example, user04 has his Jupyter server running at node2:8888, and he is tunneling it to port 8888 on his local computer. Jupyter server of user45 runs at node1:8890, and this user wanted to use his local port 7945.
